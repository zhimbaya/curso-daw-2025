...
Imprime la puntuación total obtenida por el estudiante y su nota normalizada 
entre 0 y 10.
...
max_points = (number_correct_answers + number_incorrect_answers + number_blank_answers) \
    * POINTS_CORRECT_ANSWER
points = number_correct_answers * POINTS_CORRECT_ANSWER + \
    number_incorrect_answers * POINTS_INCORRECT_ANSWER \
