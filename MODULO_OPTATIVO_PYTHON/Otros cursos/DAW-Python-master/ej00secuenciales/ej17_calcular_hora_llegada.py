...
Propósito: Un ciclista parte de una ciudad A a las HH horas, MM minutos y SS 
segundos.
...
Datos de entrada: hora, minutos y segundos de salida (enteros), segundos que 
tarda (entero).
...
departure_time_in_seconds = departure_hour * 3600 + departure_minute * 60 + \
    departure_second
