...
Propósito: Dadas dos variables numéricas A y B, que el usuario debe teclear, 
se pide intercambiar los valores de ambas.
...
Análisis:
-------------------------------------------------------------------------------
Se piden el valor de dos variables (el tipo puede ser el que queramos), hay que
...
2. Intercambio los valores. Necesito una variable auxiliar (aux). Asigno "a" en
"aux", "b" en "a" y "aux" en "b"
